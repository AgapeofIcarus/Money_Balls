...
function init() {
  ...
  var trace1  = 
  {
    x: ['$/Points(x1000)', '$/Game(x10,000)', '$/Capita', '$/Income(x10)'],
    y: [dolPerPoint/1000, dolPerGame/10000, dolPerCap, dolPerIncome/10],
    marker:{
      ...
      var data = [
        {
          ...
          mode: "gauge+number",
          gauge: {
            axis: { range: [null, 950000000], color: "blue" },
            bar: { color: "rgb(0,30,110)", thickness: 0.25 },
            steps: [
              { range: [0, 95000000], color: "rgba(0, 150, 50, 0.1)"},
              { range: [95000000, 150000000], color: "rgba(0, 150, 50, 0.2)" },
              { range: [150000000, 250000000], color: "rgba(0, 150, 50, 0.3)" },
              { range: [250000000, 350000000], color: "rgba(0, 150, 50, 0.4)" },
              { range: [350000000, 450000000], color: "rgba(0, 150, 50, 0.5)" },
              { range: [450000000, 550000000], color: "rgba(0, 150, 50, 0.6)" },
              { range: [550000000, 650000000], color: "rgba(0, 150, 50, 0.7)" },
              { range: [650000000, 750000000], color: "rgba(0, 150, 50, 0.8)" },
              { range: [750000000, 850000000], color: "rgba(0, 150, 50, 0.9)" },
              { range: [850000000, 950000000], color: "rgba(0, 150, 50, 1)" }
            ],
            threshold: {
